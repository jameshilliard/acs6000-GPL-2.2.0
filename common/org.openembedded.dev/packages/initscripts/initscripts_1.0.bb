...
SRC_URI_append_acs6000   = "\
    file://network-alias.sh \
    file://monitorpowertemp.sh \
    file://powertemp.sh"
SRC_URI_append_pmhd   = " file://setup_model.sh "
...
#
	...
	install -m 0755    ${WORKDIR}/set_pam.sh	${D}${sysconfdir}/init.d
	...
	install -m 0755    ${WORKDIR}/remount.sh        ${D}${sysconfdir}/init.d
	...
	install -m 0755    ${WORKDIR}/cracklib.sh	${D}${sysconfdir}/init.d	
...
#
	...
	if [ "${DISTRO}" = "acs6000" ]; then
		install -d ${D}/sbin/
		install -m 0755    ${WORKDIR}/monitorpowertemp.sh	${D}/sbin/
		install -m 0755    ${WORKDIR}/powertemp.sh	${D}${sysconfdir}/init.d
		ln -sf	../init.d/powertemp.sh	${D}${sysconfdir}/rc5.d/S90powertemp.sh
		install -m 0755    ${WORKDIR}/network-alias.sh ${D}${sysconfdir}/init.d
		ln -sf	../init.d/network-alias.sh	${D}${sysconfdir}/rc5.d/S99network-alias.sh
	fi
	if [ "${DISTRO}" = "pmhd" ]; then
		install -d ${D}/sbin/
		install -m 0755    ${WORKDIR}/setup_model.sh	${D}${sysconfdir}/init.d
#setup model must be before hostname.sh
		ln -sf	../init.d/setup_model.sh	${D}${sysconfdir}/rcS.d/S38setup_model.sh
	fi
...
#	ln -sf		../init.d/checkfs.sh	${D}${sysconfdir}/rcS.d/S30checkfs.sh
	...
	ln -sf  	../init.d/remount.sh	${D}${sysconfdir}/rcS.d/S36remount.sh
	...
	ln -sf		../init.d/set_pam.sh	${D}${sysconfdir}/rcS.d/S60set_pam.sh
#	ln -sf		../init.d/urandom	${D}${sysconfdir}/rcS.d/S55urandom
	ln -sf		../init.d/finish	${D}${sysconfdir}/rcS.d/S99finish
	ln -sf		../init.d/cracklib.sh	${D}${sysconfdir}/rcS.d/S40cracklib.sh
	...
	if [ "${DISTRO}" = "acs6000" ]; then
		ln -sf	../init.d/sendsigs	${D}${sysconfdir}/rc1.d/S20sendsigs
		ln -sf	../init.d/save-rtc.sh	${D}${sysconfdir}/rc1.d/S25save-rtc.sh
		ln -sf	../init.d/umountfs	${D}${sysconfdir}/rc1.d/S40umountfs
		ln -sf	../init.d/halt		${D}${sysconfdir}/rc1.d/S90halt
	fi
	if [ "${DISTRO}" = "pmhd" ]; then
		ln -sf	../init.d/sendsigs	${D}${sysconfdir}/rc1.d/S20sendsigs
		ln -sf	../init.d/umountfs	${D}${sysconfdir}/rc1.d/S40umountfs
