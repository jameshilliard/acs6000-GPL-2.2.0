...
SRC_URI_append_mergepoint = " file://pt.patch;patch=1"

SRC_URI_append_caesar = " file://sshd.pam"
...
do_install_append_caesar () {
	install -d ${D}${sysconfdir}/pam.d
	install -m 0755 ${WORKDIR}/sshd.pam ${D}${sysconfdir}/pam.d/sshd
}
