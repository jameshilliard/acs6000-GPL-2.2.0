...
SRC_URI = "http://apache.mirrors.tds.net/httpd/httpd-${PV}.tar.bz2 \
	   ...
	   file://cve-2009-3555.patch;patch=2 \
	   file://cve-2009-3555-enhancement.patch;patch=2 \
	   file://init \
	   file://httpd.conf \
	   file://httpd-ssl.conf \
	   file://httpd-avworks.conf \
	   "
...
# Expat should be found in the staging area via DEPENDS...
	...
	cp -a ${WORKDIR}/httpd.conf ${D}/${sysconfdir}/${PN}
	cp -a ${WORKDIR}/httpd-ssl.conf ${D}/${sysconfdir}/${PN}/extra
	cp -a ${WORKDIR}/httpd-avworks.conf ${D}/${sysconfdir}/${PN}/extra
