...
SRC_URI = "${SOURCEFORGE_MIRROR}/madwifi/madwifi-${PV}.tar.gz \
...
# Hack Alert :D
ARCH_mipsel = "mips"
EXTRA_OEMAKE = "--debug=bvj V=1 KERNELPATH=${STAGING_KERNEL_DIR} KERNELRELEASE=${KERNEL_VERSION} TOOLPREFIX=${TARGET_PREFIX}"
